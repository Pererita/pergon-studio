...
export default function Card({ title, description, price, svgColor, svgColorTwo, svgColorThree, spanClass, spanClassTwo, spanClassThree }: CardProps) {
  return (
    <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-pergonBlueDark">
      ...
      <ul role="list" className="space-y-5 my-7">
        ...
        <li className={`flex space-x-3 decoration-gray-500 ${spanClassThree === "gray" ? '' : 'line-through'}`}>
          ...
          <span className="text-base font-normal leading-tight text-gray-500">
            E-commerce / Sistemas de Gestión / Intranet
          </span>
        </li>
      </ul>
      <button
        type="button"
        className="text-white bg-pergonBlue hover:bg-pergonBlueDark transition duration-300 animate-float focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
      >
        Comprar
      </button>
    </div>
